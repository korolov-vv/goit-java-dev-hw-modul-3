...
insert into projects values (2, null, 5, null, 'Proj name 2', 'pending', 5, 10000);
insert into projects values (3, null, 5, null, 'Proj name 3', 'new', 5, 100000);
insert into projects values (4, null, 5, null, 'Proj name 4', 'new', 5, 5000000);
insert into projects values (5, null, 5, null, 'Proj name 5', 'new', 5, 6000000);
insert into projects values (6, null, 5, null, 'Proj name 6', 'new', 5, 7000000);
insert into projects values (7, null, 5, null, 'Proj name 7', 'new', 5, 80000);
insert into projects values (8, null, 5, null, 'Proj name 8', 'new', 5, 1000);

insert into skills values (1, 'Java', 'junior');
insert into skills values (2, 'Pyton', 'junior');
insert into skills values (1, 'JavaScript', 'junior');
insert into skills values (3, 'Rubi', 'junior');
insert into skills values (4, 'React', 'junior');
insert into skills values (5, 'CSS', 'junior');
...
values (1, 'Ivan', 'Petrov', 'male', 30, 10, 5, null);
insert into developers (developer_id, first_name, last_name, gender, age, experience_in_years, company_id, project_id)
values (2, 'Petro', 'Ivanov', 'male', 30, 10, 4, null);
insert into developers (developer_id, first_name, last_name, gender, age, experience_in_years, company_id, project_id)
values (3, 'Olexandr', 'Puszkin', 'male', 30, 10, 5, null);
insert into developers (developer_id, first_name, last_name, gender, age, experience_in_years, company_id, project_id)
values (4, 'Anton', 'Gogol', 'male', 30, 10, 2, null);
insert into developers (developer_id, first_name, last_name, gender, age, experience_in_years, company_id, project_id)
values (5, 'Serhii', 'Bulba', 'male', 30, 10, 1, null);
select * from developers

insert into customers values (1, 'Customer', 1);
insert into customers values (9, 'Customer9', 1);
insert into customers values (2, 'Customer2', 2);
insert into customers values (3, 'Customer3', 4);
insert into customers values (4, 'Customer4', 1);
insert into customers values (5, 'Customer5', 3);
insert into customers values (6, 'Customer6', 7);
insert into customers values (7, 'Customer7', 6);
insert into customers values (8, 'Customer8', 8);

insert into skills_of_developers values (1, 2);
insert into skills_of_developers values (1, 3);
insert into skills_of_developers values (1, 4);
insert into skills_of_developers values (1, 5);
insert into skills_of_developers values (2, 1);
insert into skills_of_developers values (2, 5);
insert into skills_of_developers values (3, 2);
insert into skills_of_developers values (3, 3);
insert into skills_of_developers values (4, 2);
insert into skills_of_developers values (5, 2);
insert into skills_of_developers values (5, 3);
insert into skills_of_developers values (5, 5);
insert into skills_of_developers values (5, 4);
insert into skills_of_developers values (7, 2);
insert into skills_of_developers values (8, 5);
